    ...
    try:
        ...
        if user.status == "kicked":
            await bot.send_message(
                ...
                text="Sorry baby, You are Banned to use me. Contact my Admin (https://t.me/MRGOfficial_admin).",
        ...
        await bot.send_message(
            chat_id=cmd.from_user.id,
            text="ꜱᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ ᴡʀᴏɴɢ. ᴄᴏɴᴛᴀᴄᴛ ᴍʏ Admin (https://t.me/MRGOfficial_admin).",
            disable_web_page_preview=True
        )
        return 200
    return 200
